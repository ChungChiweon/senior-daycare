    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,440px)_1fr]">
        <section className="space-y-5 rounded-md border border-line bg-white p-5 shadow-soft">
          ...
          <div>
            <label className="text-sm font-bold text-ink">사회복지사 케어 메모</label>
            <Textarea value={memo} onChange={(event) => setMemo(event.target.value)} placeholder="어르신 성함, 건강·식사·투약 상태, 당일 활동 특이사항 등 추가 맥락을 입력하세요." />
          </div>
