...
export type DocCategoryKey = "guardian" | "internal" | "program" | "promo";
...
export type GeneratedDocItem = {
  ...
  isInternal: boolean; // 내부 기록용 vs 보호자·홍보용
  content: string;
  characterCount: number;
  status: "ai_draft" | "user_edited" | "approved";
  lastModified: string;
  isLocked: boolean; // 체험 판 잠금 여부
};

export type Institution = {
  id: string;
  name: string;
  type: "daycare_senior" | "nursing_home" | "welfare_center";
  logoUrl?: string;
  address: string;
  phone: string;
};
